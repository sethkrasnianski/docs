This call returns the data required to build a dynamic flows form based on the address edit requirements. It provides all options available for the choice fields as well as those featured in relationships (eg, Customer). It also provides information of field requirements, default values, etc.

Unlike /addresses/fields this adds the current address data to the array to allow for prepopulation of fields.

#### Resource URL
[{{ api_url }}addresses/:id/fields]({{ api_url }}addresses/:id/fields)
